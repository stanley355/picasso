...
export const metadata: Metadata = {
    ...
    description: "Translate texts & full document files instantly. Accurate translations for individuals and Teams. Millions translate with Languageai every day.",
