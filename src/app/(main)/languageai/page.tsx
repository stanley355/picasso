...
const LanguageaiHome = () => {
  ...
  return (
    <div className="grid grid-rows-4 gap-4 md:p-4 md:grid-rows-none md:grid-cols-2 h-full">
      <div
        className="bg-primary text-primary-foreground rounded-md p-4 cursor-pointer"
        onClick={() => router.push("/languageai/checkbot")}
      >
      ...
      <div
        className="bg-primary text-primary-foreground rounded-md p-4 cursor-pointer"
        onClick={() => router.push("/languageai/translate")}
      >
        <div className="flex items-center gap-2  text-2xl md:text-5xl mb-4">
          <IoLanguageOutline />
          <span>Translate</span>
      ...
      <div
        className="bg-primary text-primary-foreground rounded-md p-4 cursor-pointer"
        onClick={() => router.push("/languageai/speech-to-text")}
      >
        <div className="flex items-center gap-2  text-2xl md:text-5xl mb-4">
          <AiTwotoneAudio />
      ...
      <div
        className="bg-primary text-primary-foreground rounded-md p-4 w-full cursor-pointer"
        onClick={() => router.push("/languageai/text-to-speech")}
      >
        <div className="flex items-center gap-2  text-2xl md:text-5xl mb-4">
          <RiVoiceprintLine />
