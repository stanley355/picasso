...
export const metadata: Metadata = {
    ...
    description: "Accurately convert voice to text in over 40 languages and variants using languageai. Our AI converts speech to text online. Dictate your notes in real time, or upload recordings and get them transcribed automatically in no time.",
