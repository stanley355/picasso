...
import BpsDynamicDataSearchResultPagination
  from "@/app/(main)/bps/dynamic-data/search/_components/SearchResult/SearchResultPagination";
...
const BpsDynamicDataSearchResult = async ({
  ...
  return (
    <div>
      ...
      />
      <BpsDynamicDataSearchResultPagination currentPage={searchParams.page} pageAndCount={varList.data[0] as TBpsPageAndCount} />
    </div>
  );
};
