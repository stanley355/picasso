...
const DynamicDataImageExport = ({chart, dynamicData, datacontent}: TDynamicDataImageExport) => {
    ...
    return (
        <div className="relative w-full">
            ...
            <DynamicDataChartExport elementRef={elementRef} chart={chart} dynamicData={dynamicData}
