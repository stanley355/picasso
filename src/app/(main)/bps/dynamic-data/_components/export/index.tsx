...
const DynamicDataExport = async ({searchParams, defaultVervar }: TDynamicDataExport) => {
    ...
    return (
        <div className="p-2 ">
            ...
            <div className="inline-flex gap-2">
                <DynamicDataJsonExport title={dynamicData.var[0].label} datacontent={datacontent}/>
                <DynamicDataCsvExport title={dynamicData.var[0].label} datacontent={datacontent} />
            </div>
        </div>
    )
};
