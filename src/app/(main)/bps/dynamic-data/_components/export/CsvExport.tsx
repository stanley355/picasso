...
const DynamicDataCsvExport = ({datacontent, title}: TDynamicDataCsvExport) => {
    const onClick = () => {
    ...
    return (
        <Button className="gap-2 bg-blue-500 text-white hover:bg-blue-600 hover:border-blue-600" variant="outline" onClick={onClick}>
