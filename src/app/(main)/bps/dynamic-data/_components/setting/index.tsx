...
const DynamicDataSetting = ({turvars, vervars, years, turyears, chart}: TDynamicDataSetting) => {
    return (
        <div className="p-4">
            ...
            <div className={cn("md:grid-cols-2 md:gap-4 md:place-items-center", !chart || chart === EDynamicDataChart.Table ? "hidden" : "grid")}>
