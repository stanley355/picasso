...
import {TBpsDynamicData, TBpsDynamicDataRequestParam} from "@/lib/api/bps/dynamicData/fetchBpsDynamicData";
...
const BpsDynamicDataTabs = ({baseDynamicData, searchParams, defaultVervar}: TBpsDynamicDataTable) => {
    return (
